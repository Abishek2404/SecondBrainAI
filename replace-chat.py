         ...
         <div className="p-6 flex flex-col gap-8">
            ...
            <div className="flex flex-col gap-4">
               <div className="flex items-center justify-between">
                  <h3 className="font-bold text-[15px]">Sources (3)</h3>
                  <button className="text-xs text-muted-foreground hover:text-foreground font-medium">View all</button>
               </div>
               <div className="flex flex-col gap-3">
                  <div className="p-3 rounded-xl bg-background border shadow-sm flex items-start gap-3 hover:shadow-md transition-shadow cursor-pointer">
                     <div className="p-1.5 bg-red-100 dark:bg-red-900/30 rounded-lg shrink-0">
                        <FileText className="h-5 w-5 text-red-600 dark:text-red-400" />
                     </div>
                     <div className="flex flex-col min-w-0 flex-1">
                        <span className="text-sm font-semibold truncate">CSS Notes for Professionals.pdf</span>
                        <div className="flex items-center justify-between mt-1">
                           <span className="text-xs text-muted-foreground">Page 12</span>
                           <span className="text-xs text-emerald-600 font-medium">92% match</span>
                        </div>
                     </div>
                  </div>
                  <div className="p-3 rounded-xl bg-background border shadow-sm flex items-start gap-3 hover:shadow-md transition-shadow cursor-pointer">
                     ...
                     <div className="flex flex-col min-w-0 flex-1">
                        <span className="text-sm font-semibold truncate">HTML5 Notes for Professionals.html</span>
                        <div className="flex items-center justify-between mt-1">
                           <span className="text-xs text-muted-foreground">Page 45</span>
                           <span className="text-xs text-emerald-600 font-medium">87% match</span>
                        </div>
                     </div>
                  </div>
                  <div className="p-3 rounded-xl bg-background border shadow-sm flex items-start gap-3 hover:shadow-md transition-shadow cursor-pointer">
                     ...
                     <div className="flex flex-col min-w-0 flex-1">
                        <span className="text-sm font-semibold truncate">Web Development Cheatsheet.docx</span>
                        <div className="flex items-center justify-between mt-1">
                           <span className="text-xs text-muted-foreground">Page 8</span>
                           <span className="text-xs text-emerald-600 font-medium">78% match</span>
                        </div>
                     </div>
                  </div>
               </div>
            ...
            <div className="flex flex-col gap-4">
               ...
               <div className="flex flex-col gap-2">
                  {[
                     { title: "Explain CSS Grid layout", time: "10:30 AM" },
                     { title: "What is Javascript closure?", time: "Yesterday" },
                     { title: "Explain React useState hook", time: "Yesterday" },
                     { title: "Difference between var let const", time: "2 days ago" },
                     { title: "What is Python list comprehension?", time: "2 days ago" },
                  ].map((chat, i) => (
